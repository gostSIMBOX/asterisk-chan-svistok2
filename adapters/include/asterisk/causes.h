 ...
 * causes.h - Q.931 and Asterisk hangup causes
 */
#ifndef ASTERISK_CAUSES_H
#define ASTERISK_CAUSES_H
...
#define AST_CAUSE_RESTRICTED_BEARERCAP_AVAIL    70
